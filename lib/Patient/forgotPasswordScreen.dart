...
class _forgotPasswordScreenState extends State<forgotPasswordScreen> {
  ...
  Future checkPhone() async {
    if (phoneController.text.isEmpty || newPasswordController.text.isEmpty
    ...
    else if(newPasswordController.text != reenterNewPasswordController.text)
      {print("password tak sama");
      showDialog(context: context,
          builder: (context) {
            return AlertDialog(
              title: const Text('Password Not Same'),
              content: const Text('Make sure your password are same '),
              actions: [
                TextButton(child:
                const Text('OK'),
                  onPressed: () {
      ...
      print("otw");
      var url = Uri.http("10.131.78.172", '/mediplexity/forgotPassword.php', {'q': '{http}'});
