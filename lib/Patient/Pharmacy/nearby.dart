class Nearby {
  ...
  Nearby.fromJson(Map<String, dynamic> json) {
    ...
    openingHours = json['opening_hours'] != null
        ...
        : null;
    if (json['photos'] != null) {
      photoReferences = <String>[]; // Initialize the list
      json['photos'].forEach((v) {
        photoReferences!.add(v['photo_reference']); // Add photo reference to the list
      });
    }
...
class Photos {
  ...
  String? photoReference; // Change type to String
  int? width;
  ...
  Photos.fromJson(Map<String, dynamic> json) {
    ...
    photoReference = json['photo_reference']; // Change type to String
    width = json['width'];
  }
